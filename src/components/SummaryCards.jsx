    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="pixel-card p-5 relative overflow-hidden transition-transform hover:-translate-y-0.5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="font-pixel text-lg font-semibold text-ink-soft tracking-wider uppercase mb-1">
            本月總開支
          </div>
      ...
      <div className="pixel-card p-5 relative overflow-hidden transition-transform hover:-translate-y-0.5">
        ...
        <div className="pixel-number font-pixel text-[28px] font-normal text-ink tracking-tight tabular-nums">
          <span className="font-pixel">HK$</span>{' '}
          {totalRecurringExpense.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}
        </div>
        <div className="font-pixel mt-3 text-sm text-muted flex items-center gap-2">
